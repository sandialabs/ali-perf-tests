...
echo "" >> results
echo "The Jupyter notebooks containing Blake ALI performance data can be accessed here: https://sandialabs.github.io/ali-perf-data/ali/index_blake.html" >> results
echo "" >> results
