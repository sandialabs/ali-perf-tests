...
def ctest2json(file, allTimers):
    ...
    '''
    # Use new test names and timer names
    testNameMap = {
    ...
    timerMap = {
        ...
        'Albany Fill: Jacobian Export:':'Albany Jacobian Fill: Export:'}
            ...
            for timer in timers:
                if timer in line:
                    ...
                    if timer in timerMap:
                        newTimer = timerMap[timer]
                        testInfo['timers'][newTimer] = wtime
