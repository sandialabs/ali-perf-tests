...
cp saved/* /home/projects/albany/nightlyCDashAlbanyBlake/aliPerfTests/nightlyCDash/repos/ikalash.github.io/ali/blake_nightly_ali_data
cd $BASE_DIR/repos/ikalash.github.io/ali/blake_nightly_ali_data
now=$(date +"%Y%m%d")
FILE=ctest-$now.json
git add $FILE
