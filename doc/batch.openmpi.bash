...
#SBATCH --time=0:05:00               # Wall clock time (HH:MM:SS) - once the job exceeds this time, the job will be terminated (default is 5 minutes)
...
cd /home/projects/albany/nightlyCDashAlbanyBlake/aliPerfTests/build/perf_tests
