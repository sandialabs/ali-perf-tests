...
unset http_proxy
unset https_proxy
bash nightly_cron_script_ali_perf_tests_waterman.sh
bash process_results_ctest.sh 
#bash nightly_cron_script_ali_perf_tests_waterman_bzip2_save.sh >& nightly_log_watermanALIPerfTests_saveResults.txt
